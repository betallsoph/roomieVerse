...
export default function CreateSubleasePage() {
  ...
  useEffect(() => {
    if (!isAuthenticated) {
      router.push("/auth?returnUrl=/sublease/create");
    }
  ...
  const [contractRemaining, setContractRemaining] = useState("");
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const id = await createListing({
        ...
        moveInDate: moveInDate.trim() || "Linh hoạt",
          ...
          <div className="wrapper max-w-3xl">
            ...
            <div className="mb-8">
              ...
              <p className="text-zinc-600">
                Tìm người thế chỗ, chuyển hợp đồng thuê phòng
              </p>
            </div>
            ...
            <div className="mb-6">
              ...
              <input
                ...
                maxLength={150}
                className="w-full px-4 py-3 border-2 border-black rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-emerald-300"
              />
            ...
            <div className="mb-6">
              ...
              <div className="grid grid-cols-2 gap-3 mb-3">
                <select
                  ...
                  className="px-4 py-3 border-2 border-black rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-emerald-300"
                >
                ...
                <select
                  ...
                  disabled={!city}
                  className="px-4 py-3 border-2 border-black rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-emerald-300 disabled:opacity-50"
                >
              ...
              <input
                ...
                className="w-full px-4 py-3 border-2 border-zinc-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-emerald-300 focus:border-black"
              />
            </div>
            ...
            <div className="mb-6">
              ...
              <textarea
                ...
                rows={6}
                className="w-full px-4 py-3 border-2 border-black rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-emerald-300 resize-none"
              />
              <p className="text-xs text-zinc-400 mt-1">
                  ...
                  <button
                    ...
                    className={`px-3 py-1.5 rounded-full text-sm font-medium border-2 transition-colors ${
                      amenities.includes(opt.value)
                        ? "border-black bg-emerald-200 text-emerald-900"
