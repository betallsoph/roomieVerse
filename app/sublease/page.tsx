...
import { Home, Loader2, ArrowRightLeft, Search, X, ChevronDown } from "lucide-react";
...
export default function SubleasePage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section className="bg-emerald-50 py-4 sm:py-12 md:py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          <h1 className="mb-2 sm:mb-4 text-2xl font-extrabold leading-tight sm:text-4xl md:text-5xl text-green-800">
            Phòng sang lại
          </h1>
          ...
          <div className="mt-3 sm:mt-10">
            <button onClick={() => setShowMobileFilters(!showMobileFilters)} className={`sm:hidden flex items-center gap-2 w-full px-4 py-2.5 rounded-lg border-2 border-black text-sm font-bold transition-all ${hasActiveFilters ? "bg-emerald-300" : "bg-white"}`}>
              Bộ lọc nâng cao
            ...
            <div className={`${showMobileFilters ? "block" : "hidden"} sm:block space-y-2 sm:space-y-3 mt-2 sm:mt-0`}>
              <p className="hidden sm:block text-base font-bold text-green-800">Bộ lọc nâng cao</p>
      ...
      {/* Blur transition */}
      <div className="h-3 sm:h-8 bg-gradient-to-b from-emerald-50 to-white" />
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 pb-12 sm:pb-16">
        ...
        <div>
          <div className="mb-4 sm:mb-8 space-y-1">
            ...
            <h2 className="text-xl sm:text-2xl font-bold">Phòng đang sang lại</h2>
          </div>
