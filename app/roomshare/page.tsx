...
export default function RoomSharePage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section className="bg-pink-50 py-4 sm:py-12 md:py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          ...
          <p className="hidden sm:block mb-6 sm:mb-8 max-w-3xl text-xs sm:text-base text-zinc-700">
          ...
          <div className="mt-3 sm:mt-10">
            <button onClick={() => setShowMobileFilters(!showMobileFilters)} className={`sm:hidden flex items-center gap-2 w-full px-4 py-2.5 rounded-lg border-2 border-black text-sm font-bold transition-all ${hasActiveFilters ? "bg-pink-300" : "bg-white"}`}>
              Bộ lọc nâng cao
            ...
            <div className={`${showMobileFilters ? "block" : "hidden"} sm:block space-y-2 sm:space-y-3 mt-2 sm:mt-0`}>
              <p className="hidden sm:block text-base font-bold text-pink-800">Bộ lọc nâng cao</p>
      ...
      <div className="h-3 sm:h-8 bg-gradient-to-b from-pink-50 to-white" />
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 pb-12 sm:pb-16">
        ...
        <div>
          <div className="mb-4 sm:mb-8 space-y-1">
            ...
            <h2 className="text-xl sm:text-2xl font-bold">{getListingTitle()}</h2>
          </div>
